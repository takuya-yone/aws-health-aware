...
old_event_record_latestDescription_list = (
    old_event_record['latestDescription']['S']).split('\n\n')
new_event_record_latestDescription_list = (
    new_event_record['latestDescription']['S']).split('\n\n')
...
print(list(set(old_event_record_latestDescription_list) -
           set(new_event_record_latestDescription_list)))
